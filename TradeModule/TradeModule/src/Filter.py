...
#
#     def __init__(self,stock_info_block,sec_hold_user):
#         self.sec_hold_user  = sec_hold_user
...
#                 self.all_stock_info[tmp_stock['sec_code']] = tmp_stock
#
#     def _upload_stocks(self):
#         for key,value in self.all_stock_info.items():
#             single_deposite = [key,value['sec_amount'].split('.')[0],value['sec_cur_price'],self.sec_hold_user]
#             Control.insert_deposite_tb(single_deposite)

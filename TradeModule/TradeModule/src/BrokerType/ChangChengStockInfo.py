...
class ChangChengStockInfo(AbstractStockInfo):
    ...
    def __init__(self,stock_info_block,property_block,entrust_block,sec_hold_user,finish_book_block,user_id):
        ...
        # 当前相应账户的持仓类别
        #'资金帐号', '币种', '资金余额', '可用资金', '冻结资金', '可取资金', '最新市值', '总资产', '买入冻结资金', '卖出冻结资金', '句柄', '保留信息',

        # ['12', '1', '资金帐号', '币种', '资金余额', '可用资金', '冻结资金', '可取资金', '最新市值', '总资产', '买入冻结资金', '卖出冻结资金', '句柄', '保留信息',
        # '510000014836', '0', '626.91', '626.91', '', '0.00', '9724.72', '10351.63', '0.00', '0.00', '0B0B6C48', '', '']
    ...
    def _format_property(self, **kwargs):
            ...
            if count == 1:
                ...
                for col in range(count):
                    ...
                    # out_property['fu_PL'] = '{:.2f}'.format(tmp_change + float(self.property_info['pro_use']))
